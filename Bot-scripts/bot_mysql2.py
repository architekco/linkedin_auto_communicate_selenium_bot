...
from bot_mysql import login_linkedin
...
getmessages_query = "INSERT INTO messenger_chatmessage (created_at, update_at, text, time, owner_id, is_read) VALUES ('%s','%s','%s','%s','%s','%s')"
...
def test_message():
    get_messages(user_email, user_pw)
